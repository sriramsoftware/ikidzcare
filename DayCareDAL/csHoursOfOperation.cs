...
namespace DayCareDAL
{
    public class clHoursOfOperation
    {
        ...
        {
            DayCarePL.Logger.Write(DayCarePL.LogType.INFO, DayCarePL.ModuleToLog.clHoursOfOperation, "LoadStaff", "Execute LoadStaff Method", DayCarePL.Common.GUID_DEFAULT);
