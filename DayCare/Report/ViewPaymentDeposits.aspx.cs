...
{
    public partial class ViewPaymentDeposits : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (rdpStartDate.SelectedDate.ToString() != null && rdpStartDate.SelectedDate.ToString() != "")
            {
                StartDate = Convert.ToDateTime(rdpStartDate.SelectedDate.ToString()).ToString("yyyy/MM/dd HH:mm:ss") + " AM";
            }
            if (rdpEndDate.SelectedDate.ToString() != null && rdpEndDate.SelectedDate.ToString() != "")
            {
                EndDate = Convert.ToDateTime(rdpEndDate.SelectedDate).ToString("yyyy/MM/dd HH:mm:ss") + " AM";
            }
            StringBuilder jscript = new StringBuilder();
            jscript.Append("<script>window.open('");
            jscript.Append("rptPaymentDepositsReport.aspx?StartDate=" + StartDate + "&EndDate=" + EndDate);
        ...
        #region "Private Method of Ledger Function"
