...
{
    public partial class ViewAccountReciableReport : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            jscript.Append("rptAccountReceivableReport.aspx?StartDate=" + dt);
        ...
        {
            //rgAccRec.MasterTableView.Rebind();
        }

        //protected void rgAccRec_NeedDataSource(object source, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        //{
        //    try
        //    {
        //        DayCareBAL.LedgerService proxyLoad = new DayCareBAL.LedgerService();
        ...
        //        {
        //            System.Data.DataSet ds = proxyLoad.GetAccountReceiable(new Guid(Session["CurrentSchoolYearId"].ToString()), rdpStartDate.SelectedDate.Value);


        //            rgAccRec.DataSource = ds.Tables[0].DefaultView;
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        ...
        #region "Private Method LastUpdatedLedgerMethod"
