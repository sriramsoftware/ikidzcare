<%@ Page Title="" Language="C#" MasterPageFile="~/UI/DayCareIndex.Master" AutoEventWireup="true"
    CodeBehind="FamilyChildListReport.aspx.cs" Inherits="DayCare.Report.FamilyChildListReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkboxClick(ctrl) {
            ...
            // alert(ctrl.checked);
            //debugger
            if (ctrl.id == 'ctl00_ContentPlaceHolder1_rcbfamilyList_i0_CheckBox') {
                if (ctrl.checked) {
                    selectAllCheckbox();
                }
                else {
        ...
        function collectSelectedItems() {
            //debugger;
            var combo = $find('<%= rcbfamilyList.ClientID %>');
            // alert(combo);
        ...
        function selectAllCheckbox() {
            ...
            for (var itemIndex = 0; itemIndex < itemsCount; itemIndex++) {
                ...
                //Check whether the Item's CheckBox) is checked.
                if (checkbox.checked) {
                    if (checkbox.id != 'ctl00_ContentPlaceHolder1_rcbfamilyList_i0_CheckBox') {
                        selectedItemsTexts += item.get_text() + ", ";
                        selectedItemsValues += item.get_value() + ", ";
                    }
                }
    ...
    <fieldset>
        ...
        <div class="fieldDiv">
            <div class="box pndR15 ">
                ...
                <br />
                <telerik:RadComboBox ID="rcbfamilyList" runat="server" AllowCustomText="true" HighlightTemplatedItems="true"
