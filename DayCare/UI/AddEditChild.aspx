<%@ Page Title="" Language="C#" MasterPageFile="~/UI/DayCareIndex.Master" AutoEventWireup="true"
    CodeBehind="AddEditChild.aspx.cs" Inherits="DayCare.UI.AddEditChild" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidationOnformSubmit() {
            ...
            if (document.getElementById("ctl00_ContentPlaceHolder1_ddlProg").selectedIndex > 0) {
                ...
                var startdate ;
                if (document.getElementById("ctl00_ContentPlaceHolder1_rdpStartDate").value.indexOf('-')) {
                   startdate = parseISO8601(document.getElementById("ctl00_ContentPlaceHolder1_rdpStartDate").value);
                }
                else {
                    startdate = new Date(document.getElementById("ctl00_ContentPlaceHolder1_rdpStartDate").value);
                }
                var enddate;
                if (document.getElementById("ctl00_ContentPlaceHolder1_rdpEndDate").value.indexOf('-')) {
                    enddate = parseISO8601(document.getElementById("ctl00_ContentPlaceHolder1_rdpEndDate").value);
                }
                else {
                    enddate = new Date(document.getElementById("ctl00_ContentPlaceHolder1_rdpEndDate").value);
                }
                try {
                    var SchoolYearStartDate = new Date(document.getElementById("ctl00_ContentPlaceHolder1_hdnSchoolYearStartDate").value);
                    var SchoolYearEndDate = new Date(document.getElementById("ctl00_ContentPlaceHolder1_hdnSchoolYearEndDate").value);
                }
                catch (ex) { }
                if (startdate > enddate) {
                    ErrorMsg += "Start Date must less than End Date\n";
                    ...
                    if (startdate > SchoolYearEndDate) {
                        err += "Error";
                    }
                    if (enddate < SchoolYearStartDate) {
                        err += "Error";
                    }
                    ...
                    if (err.length > 0) {
                        //ErrorMsg += "Please select Start Date or End Date \n";
                        ErrorMsg += "Start Date and End Date should be within selected school year \n";
                        //alert("startdate=" + startdate.toLocaleString() + " enddate=" + enddate.toLocaleDateString() + " SchoolYearStartDate=" + SchoolYearStartDate.toLocaleDateString() + " SchoolYearEndDate=" + SchoolYearEndDate.toLocaleDateString());
                    }
                }
    ...
    <asp:HiddenField ID="hdnSchoolYearStartDate" runat="server" />
    <asp:HiddenField ID="hdnSchoolYearEndDate" runat="server" />
    <div class="clear">
    </div>
            ...
            <div class="fieldDiv">
                ...
                <div class="left" style="width: 720px;">
                    ...
                    <div class="box pndR15" style="padding-bottom: 5px;">
                        ...
                        <asp:CheckBox ID="ChkAll" runat="server" AutoPostBack="true" onclick="javascript:return CheckUncheckWeekDay(this);" />Week
                        Days:
                    </div>
                    <div class="box pndR15" style="padding-bottom: 5px;">
                        Time:
                    ...
                    <div>
                        ...
                        <asp:HyperLink ID="hlAdditionalNotes" Text="Add/View Additional Notes" Enabled="false"
                            runat="server" CssClass="addView">Add/View Additional Notes</asp:HyperLink>
                    </div>
                    <div style="margin-left: 10px; float: left;">
                        <asp:Button ID="btnSecondary" Enabled="false" OnClick="btnSecondary_Click" runat="server"
                            Text="Add/View Secondary Program" CssClass="addView" />
                    </div>
                </div>
            </div>
        </fieldset>
    ...
    <telerik:RadGrid ID="rgAddEditChid" runat="server" AutoGenerateColumns="false" AllowFilteringByColumn="false"
        ...
        <MasterTableView DataKeyNames="Id" PagerStyle-AlwaysVisible="true" EditMode="InPlace"
            ...
            CommandItemDisplay="TopAndBottom" TableLayout="Auto" AllowFilteringByColumn="false"
            Width="100%" Name="Child">
            <DetailTables>
                <telerik:GridTableView DataKeyNames="SchoolProgramId" CssClass="RemoveBorders" AutoGenerateColumns="false"
                    ...
                    DataMember="ProgramDetail" Name="Program">
                    <ParentTableRelation>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Program" DataField="ProgramTitle" UniqueName="ProgramTitle"
